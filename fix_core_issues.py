...
# 1. Fix BFT Engine serialization import
...
# 2. Add StateLedger backward compatibility alias to state_trie.py
with open("core/ledger/state_trie.py", "a", encoding="utf-8") as f:
    f.write('''
...
print("[+] Successfully fixed BFT serialization import and added StateLedger alias!")
